...
fn is_broken_identity_path(path: &Path) -> Result<bool, Error> {
...
#[cfg(unix)]
fn create_symlink(target: impl AsRef<Path>, link: impl AsRef<Path>) -> std::io::Result<()> {
